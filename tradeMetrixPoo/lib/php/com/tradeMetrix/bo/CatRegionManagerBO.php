...
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/dao/CatRegionDAO.php';
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';
include_once $CFG->dataroot.'/lib/php/application/Utilities.php';

class CatRegionManager implements ManagerInterface{
    ...
    public function __construct(){
        ...
        $this->_objetoCatalogoDAO = new CatRegionDAO();
    ...
    public function InsertaCatRegion($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function ActualizaCatRegion($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function EliminarCatRegion($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
