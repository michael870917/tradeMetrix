...
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/dao/CatOrigenDAO.php';
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';
include_once $CFG->dataroot.'/lib/php/application/Utilities.php';

class CatOrigenManager implements ManagerInterface{
    ...
    public function __construct(){
        ...
        $this->_objetoCatalogoDAO = new CatOrigenDAO();
    ...
    public function InsertaCatOrigen($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function ActualizaCatOrigen($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function EliminarCatOrigen($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
