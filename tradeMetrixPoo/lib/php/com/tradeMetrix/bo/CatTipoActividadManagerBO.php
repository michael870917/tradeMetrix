...
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/dao/CatTipoActividadDAO.php';
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';
include_once $CFG->dataroot.'/lib/php/application/Utilities.php';

class CatTipoActividadManager implements ManagerInterface{
    ...
    public function __construct(){
        ...
        $this->_objetoCatalogoDAO = new CatTipoActividadDAO();
    ...
    public function InsertaCatTipoActividad($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function ActualizaCatTipoActividad($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function EliminarCatTipoActividad($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
