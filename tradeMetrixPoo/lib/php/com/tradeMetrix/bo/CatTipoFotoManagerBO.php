...
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/dao/CatTipoFotoDAO.php';
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';
include_once $CFG->dataroot.'/lib/php/application/Utilities.php';

class CatTipoFotoManager implements ManagerInterface{
    ...
    public function __construct(){
        ...
        $this->_objetoCatalogoDAO = new CatTipoFotoDAO();
    ...
    public function InsertaCatTipoFoto($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function ActualizaCatTipoFoto($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function EliminarCatTipoFoto($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
