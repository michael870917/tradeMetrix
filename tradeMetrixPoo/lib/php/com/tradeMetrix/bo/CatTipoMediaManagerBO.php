...
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/dao/CatTipoMediaDAO.php';
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';
include_once $CFG->dataroot.'/lib/php/application/Utilities.php';

class CatTipoMediaManager implements ManagerInterface{
    ...
    public function __construct(){
        ...
        $this->_objetoCatalogoDAO = new CatTipoMediaDAO();
    ...
    public function InsertaCatTipoMedia($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function ActualizaCatTipoMedia($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function EliminarCatTipoMedia($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
