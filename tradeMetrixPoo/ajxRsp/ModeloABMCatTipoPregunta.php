<?php
    ...
    include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatTipoPreguntaManagerBO.php';
    include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';    
    include_once $CFG->dataroot.'/lib/php/application/Utilities.php';
       
    //Instanceamiento de clases
    $utilities = new Utilities();
    $objetoClassManager = new CatTipoPreguntaManager();
    ...
    $id=$objetoClassManager->InsertaCatTipoPregunta($objetoClass);        
    if($id != false){
        echo $id;
    }
    */
    ...
    $id=$objetoClassManager->ActualizaCatTipoPregunta($objetoClass);        
    if($id != false){
        echo $id;
    }
    */
    ...
    // eliminar    
    $objetoClass->setIdCatalogo(6);
    $id=$objetoClassManager->EliminarCatTipoPregunta($objetoClass);        
    if($id != false){
        echo $id;
    }
