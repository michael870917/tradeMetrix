...
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/dao/CatTipoAccionDAO.php';
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';
include_once $CFG->dataroot.'/lib/php/application/Utilities.php';

class CatTipoAccionManager implements ManagerInterface{
    ...
    public function __construct(){
        ...
        $this->_objetoCatalogoDAO = new CatTipoAccionDAO();
    ...
    public function InsertaCatTipoAccion($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function ActualizaCatTipoAccion($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function EliminarCatTipoAccion($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
