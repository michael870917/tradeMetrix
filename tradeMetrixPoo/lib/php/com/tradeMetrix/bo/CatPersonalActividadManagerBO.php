...
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/dao/CatPersonalActividadDAO.php';
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';
include_once $CFG->dataroot.'/lib/php/application/Utilities.php';

class CatPersonalActividadManager implements ManagerInterface{
    ...
    public function __construct(){
        ...
        $this->_objetoCatalogoDAO = new CatPersonalActividadDAO();
    ...
    public function InsertaCatPersonalActividad($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function ActualizaCatPersonalActividad($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function EliminarCatPersonalActividad($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
