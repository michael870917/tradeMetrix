...
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/dao/CatVisualizacionesDAO.php';
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';
include_once $CFG->dataroot.'/lib/php/application/Utilities.php';

class CatVisualizacionesManager implements ManagerInterface{
    ...
    public function __construct(){
        ...
        $this->_objetoCatalogoDAO = new CatVisualizacionesDAO();
    ...
    public function InsertaCatVisualizaciones($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function ActualizaCatVisualizaciones($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function EliminarCatVisualizaciones($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
