...
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/dao/CatTipoPreguntaDAO.php';
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';
include_once $CFG->dataroot.'/lib/php/application/Utilities.php';

class CatTipoPreguntaManager implements ManagerInterface{
    ...
    public function __construct(){
        ...
        $this->_objetoCatalogoDAO = new CatTipoPreguntaDAO();
    ...
    public function InsertaCatTipoPregunta($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function ActualizaCatTipoPregunta($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function EliminarCatTipoPregunta($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
