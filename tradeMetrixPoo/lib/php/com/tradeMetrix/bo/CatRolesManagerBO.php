...
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/dao/CatRolesDAO.php';
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';
include_once $CFG->dataroot.'/lib/php/application/Utilities.php';

class CatRolesManager implements ManagerInterface{
    ...
    public function __construct(){
        ...
        $this->_objetoCatalogoDAO = new CatRolesDAO();
    ...
    public function InsertaCatRoles($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function ActualizaCatRoles($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function EliminarCatRoles($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
