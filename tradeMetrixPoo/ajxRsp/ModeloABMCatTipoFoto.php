<?php
    ...
    include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatTipoFotoManagerBO.php';
    include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';    
    include_once $CFG->dataroot.'/lib/php/application/Utilities.php';
       
    //Instanceamiento de clases
    $utilities = new Utilities();
    $objetoClassManager = new CatTipoFotoManager();
    ...
    $id=$objetoClassManager->InsertaCatTipoFoto($objetoClass);        
    if($id != false){
        echo $id;
    }
    */
    ...
    $id=$objetoClassManager->ActualizaCatTipoFoto($objetoClass);        
    if($id != false){
        echo $id;
    }
    */
    ...
    // eliminar    
    $objetoClass->setIdCatalogo(6);
    $id=$objetoClassManager->EliminarCatTipoFoto($objetoClass);        
    if($id != false){
        echo $id;
    }
