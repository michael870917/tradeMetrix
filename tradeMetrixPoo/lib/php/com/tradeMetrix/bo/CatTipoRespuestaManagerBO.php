...
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/dao/CatTipoRespuestaDAO.php';
include_once $CFG->dataroot.'/lib/php/com/tradeMetrix/bo/CatalogoGenerico.php';
include_once $CFG->dataroot.'/lib/php/application/Utilities.php';

class CatTipoRespuestaManager implements ManagerInterface{
    ...
    public function __construct(){
        ...
        $this->_objetoCatalogoDAO = new CatTipoRespuestaDAO();
    ...
    public function InsertaCatTipoRespuesta($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function ActualizaCatTipoRespuesta($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
    ...
    public function EliminarCatTipoRespuesta($obj){
        if($obj != "" || $obj != NULL){
            if(is_object($obj)){
